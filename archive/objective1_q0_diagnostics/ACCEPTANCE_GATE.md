...
>
> The q0 acceptance criteria set during the spin-SCF campaign; the campaign is closed and the live gate is Q0_NEB_GATE.md.
>
> **Current authority: `results/objective1/dft/charge_relaxed/Q0_NEB_GATE.md`.** This file is retained verbatim below for provenance; do not cite it as current.
