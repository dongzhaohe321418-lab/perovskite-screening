...
>
> Fixed-path single-point tracer-bullet report. Its method (MACE geometries, single-point DFT) and its 141/127 meV numbers are superseded by the relaxed-NEB campaign; the Tyagi-ordering claim it flirts with is banned.
>
> **Current authority: `results/objective1/dft/charge_relaxed/Q0_NEB_GATE.md + CHARGE_STATE_ANCHOR.md`.** This file is retained verbatim below for provenance; do not cite it as current.
